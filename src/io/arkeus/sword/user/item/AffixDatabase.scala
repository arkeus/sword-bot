...
object AffixDatabase extends Database[Affix] {
	def build(affixes: List[(String, AffixType.Value, Rarity.Value, Map[String, (Double, Int)])]) = {
		...
		for (affix <- affixes) {
			...
			val aff = new Affix(name, category, rarity, properties)
			ids += aff
			names.put(name, aff)
			id += 1
		}
	...
	build(List(
		...
		// DUAL RESIST
		("Volcanoward", AffixType.Prefix, Rarity.Rare, Map("Fire Resistance" -> (0.4, 10), "Earth Resistance" -> (0.4, 10))),
		("Blizzardward", AffixType.Prefix, Rarity.Rare, Map("Ice Resistance" -> (0.4, 10), "Air Resistance" -> (0.4, 10))),
		("Steamward", AffixType.Prefix, Rarity.Rare, Map("Fire Resistance" -> (0.4, 10), "Ice Resistance" -> (0.4, 10))),
		("Spireward", AffixType.Prefix, Rarity.Rare, Map("Air Resistance" -> (0.4, 10), "Earth Resistance" -> (0.4, 10))),
		////// Suffix
		//// Common
		// BASE STATS
		...
		// RESISTS
		("of Refraction", AffixType.Suffix, Rarity.Common, Map("Fire Resistance" -> (0.1, 3), "Earth Resistance" -> (0.1, 3), "Ice Resistance" -> (0.1, 3), "Air Resistance" -> (0.1, 3))),
		//// Rare
		// BASE STATS
		...
		// RESISTS
		("of Reflection", AffixType.Suffix, Rarity.Rare, Map("Fire Resistance" -> (0.2, 7), "Earth Resistance" -> (0.2, 7), "Ice Resistance" -> (0.2, 7), "Air Resistance" -> (0.2, 7)))))
